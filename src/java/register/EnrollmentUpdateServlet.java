...
public class EnrollmentUpdateServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String sql = "UPDATE enrollments SET student_id=?, academic_year=?, grade_level=?, section=?, " +
                         "enrollment_type=?, enrollment_date=?, status=? WHERE enrollment_id=?";
            ...
            response.getWriter().print("Enrollment updated successfully");
